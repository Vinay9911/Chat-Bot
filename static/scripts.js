document.addEventListener('DOMContentLoaded', function () {
    ...
    const toggleImages1 = [
        'http://127.0.0.1:5000/static/1.jpg', // Image 1 for button 1
        'http://127.0.0.1:5000/static/2.jpg' // Image 2 for button 1
    ];
    const toggleImages2 = [
        'http://127.0.0.1:5000/static/4.jpg', // Image 1 for button 2
        'http://127.0.0.1:5000/static/5.jpg' // Image 2 for button 2
    ];
    ...
    function callApi(message) {
        ...
        .then(data => {
            ...
            img3.src = 'http://127.0.0.1:5000/static/3.jpg'; // Static image
